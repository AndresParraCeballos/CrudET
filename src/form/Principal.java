            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(txtApe, javax.swing.GroupLayout.PREFERRED_SIZE, 127, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(11, 11, 11))
        );
...
//              
            ...
            while (rs.next()) {
                ...
                persona[2] = rs.getString("usu_nombres");
                persona[3] = rs.getString("usu_apellidos");
    ...
    void Agregar() {
        ...
        try {
            if (cedula.equals("") || nom.equals("")||ape.equals("")) {
                JOptionPane.showMessageDialog(null, "Debe Ingresar Datos");
                limpiarTabla(model);               
            } else {
                String sql = "insert into usuario(usu_nombres,usu_apellidos,cedula) values('" + nom + "','" + ape + "','" + cedula + "')";
                con = cn.getConnection();
                st = con.createStatement();
    ...
    void Modificar() {
        ...
        String nom = txtNom.getText();
        String ape = txtApe.getText();
        String sql = "update usuario set cedula='" + cedula + "',usu_nombres='" + nom +"',usu_apellidos='" + ape + "' where idUsuario=" + id;
        try {
            if (cedula != null || nom != null || ape != null) {
                con = cn.getConnection();
                st = con.createStatement();
                st.executeUpdate(sql);
